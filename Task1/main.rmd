...
Usando el software estadístico R y la función sample(). De esta manera cualquier hogar tendra la misma probabilidad de ser seleccionado en el estudio. Ademas se fija una semilla con el fin de permitir reproducibilidad del estudio.
...
print("#  pp   Error comparado  con alfa/2 = 0.03")
...
tener adultos mayores, bastaría con multiplicar N por cada limite, de cada intervalo
seleccionado en el literal anterior. Dando como resultado
